...
import {DropDown, Spacing, SwitchComponent} from '../../components';
          ...
          <KeyboardAvoidingView enabled>
            <View style={SettingStyles.KeyBordTopViewStyle}>
              <View style={SettingStyles.MinFlexView}>
                ...
                <Text style={LanguageStyless.Settingtext}>
                  {t('Select_Your_Language')}
                </Text>
                <View
                  style={
                    isFocus
                      ? LanguageStyless.LeadsDropdownbox
                      : LanguageStyless.LeadsDropdownboxOpen
                  }>
                  <DropDown
                    data={DataofDropdown}
                    dropdownStyle={LanguageStyless.LeadDropdown}
                    onChange={item => {
                      changeLanguage(item.value);
                    }}
                    search
                    searchPlaceholder="Search bar"
                    selectedTextStyle={LanguageStyless.selectedTextStyleLead}
